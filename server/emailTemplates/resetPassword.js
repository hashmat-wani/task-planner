import { DEV_API, MODE, PROD_API } from "../utils/env.js";

export default function resetPassword(name, token) {
  return `<div>
    
      <div style="background:#0a66c2;padding:20px;color:white;text-align:center;">
        <h3>Thankyou for choosing Task Planner</h3>
        <p>Reset your Task Planner password</p>
      </div>
